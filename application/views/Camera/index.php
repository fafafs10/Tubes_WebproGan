...
<body>
      ...
      <div class="row mt-3">
        <div class="col-md-6">
          <div class="alert alert-success alert-dismissible fade show" role="alert">
            Data Camera<strong> berhasil </strong> <?= $this->session->flashdata('flash'); ?>
  ...
  <section class="table-product">
    <div class="container">
      <div class="row">
        <div class="col-3">
          <a class="btn btn-primary" href="<?= base_url(); ?>Camera/tambah">Insert Data</a>
        </div>
        <div class="col-3" style="float: right; margin-left: 650px;">
        ...
        <tbody>
          ...
          foreach ($camera as $c) : ?>
            <tr>
              ...
              <td><?= $c['harga']; ?></td>
              <td>
                <a href="<?= base_url(); ?>Camera/edit/<?= $c['id_camera']; ?>" class="badge bg-primary">Edit</a>
              </td>
              <td>
                <a href="<?= base_url(); ?>Camera/hapus/<?= $c['id_camera']; ?>" class="badge bg-danger" onclick="return confirm('yakin mau hapus data?');">Delete</a>
              </td>
            </tr>
          <?php endforeach ?>
        </tbody>
  ...
  <!-- Jumbotron -->
  <div class="jumbotron">
    <img src="<?= base_url(); ?>Assets/images/J-Camera" alt="" width="100%">
  ...
  <div class="jumbotron">
    <div class="container">
      <img src="<?= base_url(); ?>Assets/images/large-img.webp" alt="" width="100%">
    </div>
  </div>
  <!-- end large-image -->
  ...
  <section class="c-slider">
    <div class="container">
      <p class="title">Discover a world of visual expression</p>
      <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          ...
          <div class="carousel-item active">
            <div class="row">
              <div class="col-4">
                <img src="<?= base_url(); ?>Assets/images/cslider-1.webp" class="d-block h-100 w-auto" alt="...">
              </div>
              <div class="col-4">
                <img src="<?= base_url(); ?>Assets/images/cslider-2.webp" class="d-block h-100 w-auto" alt="...">
              </div>
              <div class="col-4">
                <img src="<?= base_url(); ?>Assets/images/cslider-3.webp" class="d-block h-100 w-auto" alt="...">
              </div>
            </div>
          </div>
          <!-- Slider 2 -->
          <div class="carousel-item">
            <div class="row">
              <div class="col-4">
                <img src="<?= base_url(); ?>Assets/images/cslider-4.webp" class="d-block h-100 w-auto" alt="...">
              </div>
              <div class="col-4">
                <img src="<?= base_url(); ?>Assets/images/cslider-5.webp" class="d-block h-100 w-auto" alt="...">
              </div>
              <div class="col-4">
                <img src="<?= base_url(); ?>Assets/images/cslider-6.webp" class="d-block h-100 w-auto" alt="...">
              </div>
            </div>
          </div>
          <!-- Slider 3 -->
          <div class="carousel-item">
            <div class="row">
              <div class="col-4">
                <img src="<?= base_url(); ?>Assets/images/cslider-7.webp" class="d-block h-100 w-auto" alt="...">
              </div>
              <div class="col-4">
                <img src="<?= base_url(); ?>Assets/images/cslider-8.webp" class="d-block h-100 w-auto" alt="...">
              </div>
              <div class="col-4">
                <img src="<?= base_url(); ?>Assets/images/cslider-9.webp" class="d-block h-100 w-auto" alt="...">
              </div>
            </div>
          </div>
        </div>
  ...
  <!-- Card -->
  <section class="camera-card cc1">
    <div class="container c">
      <p class="title">Engineered to inspire</p>
      <div class="row">
        <div class="col-4">
          <div class="card c1">
            <img src="<?= base_url(); ?>Assets/images/cc1.webp" class="card-img-top" alt="card1" height="500px">
          </div>
        </div>
        <div class="col-4">
          <div class="card c2">
            <img src="<?= base_url(); ?>Assets/images/cc2.webp" class="card-img-top" alt="card2" height="500px">
          </div>
        </div>
        <div class="col-4">
          <div class="card c3">
            <img src="<?= base_url(); ?>Assets/images/cc3.webp" class="card-img-top" alt="card3" height="500px">
          </div>
        </div>
      </div>
    </div>
  ...
  <!-- Card -->
  <section class="camera-card cc2">
    <div class="container c">
      <p class="title">Creative tools for the creator in you</p>
      <div class="row">
        <div class="col-4">
          <div class="card c1">
            <img src="<?= base_url(); ?>Assets/images/cc4.webp" class="card-img-top" alt="card1" height="500px">
          </div>
        </div>
        <div class="col-4">
          <div class="card c2">
            <img src="<?= base_url(); ?>Assets/images/cc5.webp" class="card-img-top" alt="card2" height="500px">
          </div>
        </div>
        <div class="col-4">
          <div class="card c3">
            <img src="<?= base_url(); ?>Assets/images/cc6.webp" class="card-img-top" alt="card3" height="500px">
          </div>
        </div>
      </div>
    </div>
  ...
  <!-- Card -->
  <section class="camera-card cc3">
    <div class="container c">
      <p class="title">Experience our worlds of imagination</p>
      <div class="row">
        <div class="col">
          <div class="card c1">
            <img src="<?= base_url(); ?>Assets/images/cc7.webp" class="card-img-top" alt="card1" height="500px">
          </div>
        </div>
        <div class="col">
          <div class="card c2">
            <img src="<?= base_url(); ?>Assets/images/cc8.webp" class="card-img-top" alt="card2" height="500px">
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="recently-view">
    <div class="container">
      ...
      <div class="row">
        <div class="col-3">
          <div class="card c1">
            <img height="140" width="140" src="<?= base_url(); ?>Assets/images/speaker.webp" class="card-img-top" alt="...">
            <div class="card-body">
        ...
        <div class="col-3">
          <div class="card c2">
            <img height="140" width="140" src="<?= base_url(); ?>Assets/images/camera.png" class="card-img-top" alt="...">
            <div class="card-body">
              <p class="card-text">XB43 EXTRA BASS™ Portable BLUETOOTH® Speaker</p>
            </div>
          </div>
        ...
        <div class="col-3">
          <div class="card c3">
            <img height="140" width="140" src="<?= base_url(); ?>Assets/images/headset.png" class="card-img-top" alt="...">
            <div class="card-body">
              <p class="card-text">XB43 EXTRA BASS™ Portable BLUETOOTH® Speaker</p>
            </div>
          </div>
