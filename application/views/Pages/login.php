  ...
  <div class="p-5 text-center bg-image">
    <div class="d-flex justify-content-start align-items-center h-100">
      <div class="login-banner">
        <h2>Welcome to My Sony</h2>
        <div class="row rwc1">
          <div class="col-sm-6 c1">
            <h3>Already Have An Account?</h3>
            <p>If you wish to check your product warranty details or update your contact details in your subscription, please click below to sign in. </p>
            <a href="<?= base_url('pages/signIn'); ?>" type="button" class="btn btn-primary">Sign In</a>
            <p class="forget-pass">Forget <a href="#">Password</a>?</p>
            <p><a href="#">Request Help</a></p>
          </div>
          <div class="col-sm-6 c2">
            <h3>Not a Sony Member yet?</h3>
            <p>Click below to register your product or sign up for eNewsletter.</p>
            <a href="<?= base_url('pages/register'); ?>" type="button" class="btn btn-primary">Register Here</a>
          </div>
        </div>
      </div>
    </div>
